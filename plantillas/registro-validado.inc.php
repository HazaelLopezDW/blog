<div class="form-group">   
    ...
    <input type="text" class="form-control" placeholder="Nombre-Apellidos!!!" name="nombre">
</div>
<div class="form-group">   
    <label>Email</label>
    <input type="text" class="form-control" placeholder="NombreApellidos@mail.com!!!" name="email">
</div>
<div class="form-group">   
